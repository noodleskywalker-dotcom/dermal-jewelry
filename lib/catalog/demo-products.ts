...
export const demoProducts: Product[] = [
  ...
  family({
    ...
    origin: "original",
    lines: ["full", "symbolic", "ancient", "featured"],
    summary: "An ancient eye in polished linework, held on a curved surface bar, with a dark faceted stone at its centre.",
    story:
      "An ancient line, reduced to a modern form. The eye is drawn in polished metal: a curved bar with a ball at each end carries it, a dark faceted stone sits at its centre, the spiral falls from the inner corner and the pointed drop hangs below. Protection. Balance. Expression.",
    defaultFormId: "anti-eyebrow",
    forms: [
      {
        id: "anti-eyebrow",
        ...
        status: "available",
        placement: "anti-eyebrow",
        // One piece, not a pair: the bar, its two balls and the decoration are a single object, the way
        // the owner's reference shows it worn.
        components: [{ id: "piece", label: "Surface bar with the eye, the stone, the curl and the drop", art: "horus-piece", x: 0, y: 0, size: 1 }],
        hardware: "integrated",
        composition: {
          approved: false,
          artClass: "concept-fallback",
          note: "Concept artwork drawn from the owner's reference of 22 September 2026 (an internal render, not manufacturer CAD). Proportions follow that image; no dimension here is a measurement.",
        },
        defaultScale: 0.17,
        demoPrice: 0,
        packageContents: "Not confirmed. The reference shows one surface bar with two ball ends and the decoration in one piece.",
        note: "Prototype specification. The metal, the stone, the bar and every dimension are still to be confirmed.",
      },
      // A single-point version exists only as a direction: the eye on its own, never the whole piece shrunk.
      pendingForm("micro-dermal", "Micro dermal", "dermal"),
      pendingForm("nose", "Nose", "nostril"),
    ],
    reveal: NO_REVEAL,
    specs: [
      { label: "Material status", value: "Prototype specification", status: "unverified" },
      { label: "Stone", value: "Dark faceted gemstone — material not yet confirmed", status: "unverified" },
      { label: "Base metal", value: "Not yet confirmed", status: "unverified" },
      { label: "Finish", value: "Polished — proposed", status: "unverified" },
      { label: "Hardware", value: "Anti-eyebrow surface-bar concept — final specification pending", status: "unverified" },
      { label: "Dimensions", value: UNVERIFIED, status: "unverified" },
      { label: "Thread system", value: UNVERIFIED, status: "unverified" },
      { label: "Compatible hardware", value: UNVERIFIED, status: "unverified" },
    ],
    materials: [
      ...
      { id: "stone", label: "Dark faceted gemstone", status: "Material not yet confirmed" },
      { id: "finish", label: "Polished finish", status: "Proposed" },
    ],
    // Prepared on 23 September 2026 from the owner's reference. The piece keeps its shape in every
    // frame; the record of the generations is in `references/generated/horus/RECORD.md`.
    media: {
      hero: "/media/horus-trace/hero.jpg",
      poster: "/media/horus-trace/poster.jpg",
      film: [
        { src: "/media/horus-trace/film.webm", type: "video/webm" },
        { src: "/media/horus-trace/film.mp4", type: "video/mp4" },
      ],
      angle: "/media/horus-trace/angle.jpg",
    ...
    forms: [
      {
        ...
        status: "available",
        placement: "dermal",
        // The reference (a worn photograph) shows a long thin line with the small crossing mark at its
        // outer end, both lying flat on the cheek.
        components: [
          { id: "line", label: "Line (inner)", art: "cross-line", x: -0.12, y: 0, size: 0.66, symmetric: true },
          { id: "cross", label: "Crossing mark (outer)", art: "cross-mark", x: 0.33, y: -0.02, size: 0.17, symmetric: true },
        ],
        composition: {
          approved: false,
          artClass: "concept-fallback",
        ...
        defaultScale: 0.11,
        demoPrice: 0,
        packageContents: "Not confirmed. This concept shows two decorative tops.",
  ...
  family({
    ...
    summary: "A small polished ankh, worn high on the cheek near the outer eye.",
    story:
      "One of the oldest marks people have worn, kept small and quiet: a loop, a bar and a stem, held close to the outer corner of the eye.",
    defaultFormId: "micro-dermal",
    forms: [
      {
        id: "micro-dermal",
        ...
        status: "available",
        placement: "dermal",
        components: single("ankh", "Ankh top", "ankh", 0.7),
        composition: {
          approved: false,
          artClass: "concept-fallback",
          note: "Concept artwork drawn from the owner's worn reference of 22 September 2026. It follows the proportions in that image and is not the product's geometry.",
        },
        defaultScale: 0.055,
        demoPrice: 0,
        packageContents: "Not confirmed. This concept shows one decorative top.",
        note: "Concept product, kept small by intention. Price, metal, finish, dimensions and hardware are all undecided.",
      },
      pendingForm("anti-eyebrow", "Anti-eyebrow", "anti-eyebrow"),
      pendingForm("nose", "Nose", "nostril"),
    ],
  ...
  // description. Nothing here carries a price, a material or a piece of hardware as a fact.
];
