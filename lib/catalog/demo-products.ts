...
export const demoProducts: Product[] = [
    ...
    forms: [
      {
        ...
        placement: "dermal",
        components: [
          { id: "line", label: "Line (outer)", art: "cross-line", x: 0.16, y: 0, size: 0.6, symmetric: true },
          { id: "cross", label: "Crossing mark (inner)", art: "cross-mark", x: -0.3, y: 0, size: 0.22, symmetric: true },
        ],
        composition: {
          approved: false,
          artClass: "concept-fallback",
          note: "Concept placeholder drawn from the owner's description on 23 September 2026. The reference image is not on this machine, and this is not the product's geometry.",
        },
        defaultScale: 0.1,
        demoPrice: 0,
    ...
    forms: [
      {
        ...
        status: "available",
        placement: "dermal",
        components: single("ankh", "Ankh top", "ankh", 0.78),
        composition: {
          approved: false,
          artClass: "concept-fallback",
          note: "Concept placeholder drawn from the owner's description on 23 September 2026. The reference image is not on this machine, and this is not the product's geometry.",
  ...
  family({
    ...
    summary: "An eye-inspired openwork frame around a dark faceted stone, with a pointed drop below.",
    story:
      "The most developed of the three concepts: an openwork eye carries a dark stone at its centre, a curved line runs out past it, and a small pointed element hangs below and inside. A surface-bar concept holds it; the final hardware is not decided.",
    defaultFormId: "anti-eyebrow",
    forms: [
      {
        id: "anti-eyebrow",
        ...
        placement: "anti-eyebrow",
        components: [
          { id: "eye", label: "Eye frame with stone (upper, outer)", art: "horus-eye", x: 0.26, y: -0.18, size: 0.54 },
          { id: "drop", label: "Pointed drop (lower, inner)", art: "horus-drop", x: -0.28, y: 0.22, size: 0.2 },
        ],
        composition: {
          approved: false,
          artClass: "concept-fallback",
        ...
        defaultScale: 0.13,
        demoPrice: 0,
        packageContents: "Not confirmed. This concept shows a decorative frame and a small drop on a surface-bar concept.",
        note: "Concept product on a surface-bar concept. The bar, the ball ends, the stone and every dimension are undecided.",
      },
      {
        id: "micro-dermal",
        label: "Micro dermal",
        status: "available",
        placement: "dermal",
        components: single("stone", "Dark stone top", "dark-gem", 0.8),
        composition: {
          approved: false,
          artClass: "concept-fallback",
          note: "Concept placeholder: the dark stone on its own, never the anti-eyebrow piece made smaller.",
        },
        defaultScale: 0.05,
        demoPrice: 0,
        packageContents: "Not confirmed. This concept shows one decorative top.",
        note: "Concept product. The stone is not identified and the hardware is undecided.",
      },
      pendingForm("nose", "Nose", "nostril"),
    ],
    reveal: NO_REVEAL,
    specs: [
      ...
      { label: "Finish", value: "Polished — proposed", status: "unverified" },
      { label: "Hardware", value: "Surface-bar concept — final specification pending", status: "unverified" },
      { label: "Dimensions", value: UNVERIFIED, status: "unverified" },
      { label: "Thread system", value: UNVERIFIED, status: "unverified" },
      { label: "Compatible hardware", value: UNVERIFIED, status: "unverified" },
    ],
